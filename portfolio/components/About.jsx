...
const About = () => {
    return (
        <div className="w-full h-screen p-2 flex items-center py-16 text-center">
                <div className="w-full flex justify-center items-center flex-col">
                    <h1 className="inline-block border-b-4 border-gray-300 py-2 mb-12">
                        About Me
                    </h1>
                    <ul className="flex flex-wrap justify-center items-center flex-col sm:flex-row ml-20 gap-8">
                        <li className='flex w-[100%] flex-[40%]'>
                            <div>
                                <CgProfile size={25}/>
                            </div>
                            <div className='ml-4'>
                        ...
                        <li className='flex w-[100%] flex-[40%] mt-3'>
                            <div>
